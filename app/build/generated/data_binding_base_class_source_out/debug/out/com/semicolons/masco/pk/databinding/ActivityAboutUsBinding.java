...
public final class ActivityAboutUsBinding implements ViewBinding {
  ...
  private ActivityAboutUsBinding(@NonNull CoordinatorLayout rootView, @NonNull Toolbar toolbar) {
  ...
  public static ActivityAboutUsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAboutUsBinding((CoordinatorLayout) rootView, toolbar);
    }
