...
public class LatestProductsAdapter extends RecyclerView.Adapter<LatestProductsAdapter.SingleItemRowHolder> {
    private ArrayList<Product> allProductsList = new ArrayList<>();

    private Context context;

    public LatestProductsAdapter(Context context, ArrayList<Product> allProductsList) {
