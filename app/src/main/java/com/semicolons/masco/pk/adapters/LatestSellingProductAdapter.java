...
public class LatestSellingProductAdapter extends RecyclerView.Adapter<LatestSellingProductAdapter.SingleItemRowHolder> {

    private static TopSellingAdapter.OnItemClickListener mlistener;
    ...
    public LatestSellingProductAdapter(ArrayList<Product> topSellingList, List<CartDataTable> cartDataTableList, Context context) {
    ...
    @NonNull
    @Override
    public LatestSellingProductAdapter.SingleItemRowHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.temp_top_selling_products, viewGroup, false);
        LatestSellingProductAdapter.SingleItemRowHolder categoriesListVH = new LatestSellingProductAdapter.SingleItemRowHolder(view);
        return categoriesListVH;
    }
    @Override
    public void onBindViewHolder(@NonNull LatestSellingProductAdapter.SingleItemRowHolder holder, int position) {

        LatestSellingProductAdapter.SingleItemRowHolder viewHolder = (LatestSellingProductAdapter.SingleItemRowHolder) holder;
    ...
    public void setOnItemClickListener(TopSellingAdapter.OnItemClickListener listener) {
